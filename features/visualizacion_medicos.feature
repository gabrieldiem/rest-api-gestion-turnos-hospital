...
Y se observa el médico con nombre "María", apellido "Fernández", matricula "NAC123", especialista en "Traumatologia" con codigo de especialidad "trau"
Y se observa el médico con nombre "Pedro", apellido "Sueco", matricula "NAC001", especialista en "Cardiologia" con codigo de especialidad "card"
Y se observa el médico con nombre "Juan", apellido "Perez", matricula "PROV001", especialista en "Pediatria" con codigo de especialidad "pedi"
