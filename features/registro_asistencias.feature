...
Característica: Registrar asistencia de paciente al turno
  ...
  Escenario: 18.0.1 - Registrar asistencia exitosa (presente)
    ...
    Cuando envío los datos de asistencia con DNI "12345678", ID de turno "1" y asistencia "true"
  ...
  Escenario: 18.0.2 - Registrar asistencia exitosa (ausente)
    ...
    Cuando envío los datos de asistencia con DNI "12345678", ID de turno "100" y asistencia "false"
    Entonces recibo el mensaje "OK"
  ...
  Escenario: 18.0.3 - Actualizar asistencia existente
    ...
    Cuando envío los datos actualizados con DNI "12345678", ID de turno "100" y asistencia "false"
    Entonces recibo el mensaje "OK"
  ...
  Escenario: 18.0.4 - Registrar asistencia con paciente inexistente
    ...
    Cuando envío los datos de asistencia con DNI "99999999", ID de turno "100" y asistencia "true"
  ...
  Escenario: 18.0.5 - Registrar asistencia con turno inexistente
    ...
    Cuando envío los datos de asistencia con DNI "12345678", ID de turno "999" y asistencia "true"
  ...
  Escenario: 18.0.6 - Registrar asistencia con turno que no pertenece al paciente
    ...
    Y existe un paciente con DNI "22222222"
    Y existe un turno con ID "100" asignado al paciente con DNI "11111111"
    Cuando envío los datos de asistencia con DNI "22222222", ID de turno "100" y asistencia "true"
