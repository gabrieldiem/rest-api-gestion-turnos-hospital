...
describe ProveedorDeHoraFijo do
  it 'devuelve la hora fija pasada como objeto Hora' do
    hora = Hora.new(10, 31)
    proveedor = described_class.new(hora)
